# prepNFB
This is a Matlab based toolbox to prepare for and coregister between OpenNFT [OpenNFT](https://github.com/OpenNFT/OpenNFT "Named link title")  Neurofeedback session(s).<br/> 
