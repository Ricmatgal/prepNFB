function my_spm_image(action,f,varargin)
...
% moved.  Clicking on the 'Originq' button will move the cursor back to the
...
%     spm_figure('Clear','Interactive'); % this will clear the window, we
%     dont want that we want BLOBS!
